...
public class RunDialog extends JDialog {
    ...
    private JTextField ofsaaVersion;
    ...
    public RunDialog(Frame parent) {
        ...
        typeLabel = new JLabel("OFSAA Version(8.1/8.0): ");
        cs.gridx = 0;
        cs.gridy = 2;
        cs.gridwidth = 1;
        panel.add(typeLabel, cs);
 
        ofsaaVersion = new JTextField(20);
        cs.gridx = 1;
        cs.gridy = 2;
        cs.gridwidth = 3;
        panel.add(ofsaaVersion, cs);
        ...
        btnRun.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (validateText()) {            	
                	...
                	succeeded=createRunChart.getExcel(getRunID(), getBatchType(),getOfsaaVersion());
                	if(succeeded) {
    ...
    public String getOfsaaVersion() {
        return ofsaaVersion.getText().trim().toUpperCase();
    }
    ...
    protected boolean validateText() {
    	...
    	if(getBatchType()==null || getBatchType().trim().equals(""))
    		return false;
    	if(getOfsaaVersion()==null || getOfsaaVersion().trim().equals(""))
    		return false;
    	else
    		return true;
    }
