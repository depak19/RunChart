...
import com.main.excel.service.ReadT2T;
...
public class AppUtil {
	...
	public static  T2TMapping getT2TDetailsXml(HSSFWorkbook hwb,String taskName,String sheetName) throws Exception{
		return ReadT2TXml.readXMLFileCreateXLS(SOURCE_DIR,taskName,SOURCE_NAME);
	}
	public static  T2TMapping getT2TDetails(HSSFWorkbook hwb,String taskName,String sheetName) throws Exception{
		return ReadT2T.getT2TMapping(taskName);
	}
