...
public class ReadT2TXml {
	static String joinDir = "\\STAGE\\";
	static String mappingDir = "\\"+Configurations.getInstance().getProperty(Constants.INFODOM)+"\\erwin\\Sources\\";
	
	public ReadT2TXml() {
		super();
	}
	public static XmlData readXMLFileCreateXLS(String dir,String XmlFile,String source) throws FileNotFoundException {
