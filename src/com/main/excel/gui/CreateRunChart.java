...
public class CreateRunChart {
	...
	public static void main(String[] args){
		...
		ct.getExcel("1661465449779","R");
		//ct.getExcel("LOAD_FSI","B");
	}
	 
	public boolean getExcel(String runID,String type) {
		try {
			...
			while (rs1.next()){
				...
				/*Data Transformation*/
				else if(taskType.startsWith("DATE1")) {
					//System.out.print("Task Name:"+taskName+" : "+AppUtil.showTime());
				...
				/*T2T*/
					...
					XmlData xmlData=AppUtil.getT2TDetails(hwb,taskName,sheetName);
					metadataDetailSheet.t2TDetailPopulation(hwb, sheet1, xmlData);
